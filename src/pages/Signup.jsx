            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  id="name"
                  {...register('name')}
                  className={`w-full pl-12 pr-4 py-4 border-2 rounded-2xl focus:outline-none focus:ring-2 transition-all duration-300 text-lg ${errors.name
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  id="phone"
                  {...register('phone')}
                  className={`w-full pl-12 pr-4 py-4 border-2 rounded-2xl focus:outline-none focus:ring-2 transition-all duration-300 text-lg ${errors.phone
                    ? 'border-red-500 focus:ring-red-500 bg-red-50'
                    : 'border-gray-200 focus:ring-purple-500 focus:border-purple-500 bg-white'
                    }`}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-12 pr-12 py-4 border-2 rounded-2xl focus:outline-none focus:ring-2 transition-all duration-300 text-lg ${errors.confirmPassword
                    ? 'border-red-500 focus:ring-red-500 bg-red-50'
                    : 'border-gray-200 focus:ring-purple-500 focus:border-purple-500 bg-white'
                    }`}
