...
const OperatorCard = ({ operator, isSelected, onSelect }) => {
  ...
  return (
    <motion.div
      ...
      whileTap={{ scale: 0.95 }}
      className={`p-8 rounded-3xl cursor-pointer transition-all duration-300 ${isSelected
    ...
    >
      ...
      <div className="text-center">
        <motion.div
          ...
          className="w-20 h-20 mx-auto mb-6 flex items-center justify-center bg-white rounded-2xl p-3 shadow-md"
        >
          <img
            src={operator.logo}
